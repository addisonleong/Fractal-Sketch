...
void createFractalSet311(int step, int vertices) {
    ...
    [B addObject:[NSNumber numberWithFloat:0]];
    int p = 0;
    createMasterMatrices1();
    for (int i = 0; i != step + 1; i++) {
        if (g1 == 1) {
            for (int a = p; a != p + pow(gens, i) * vertices; a++) {
                pt = ApplyMatrixToPoint2([[xs objectAtIndex:(a)]intValue], [[ys objectAtIndex:(a)]intValue], M1);
        ...
        if (g2 == 1) {
            for (int a = p; a != p + pow(gens, i) * vertices; a++) {
                pt = ApplyMatrixToPoint2([[xs objectAtIndex:(a)]intValue], [[ys objectAtIndex:(a)]intValue], M2);
                NSNumber *xy = [NSNumber numberWithDouble:(pt.c[0][0])];
                NSNumber *yx = [NSNumber numberWithDouble:(pt.c[1][0])];
                [xs addObject:xy];
                [ys addObject:yx];
        ...
        if (g3 == 1) {
            for (int a = p; a != p + pow(gens, i) * vertices; a++) {
                pt = ApplyMatrixToPoint2([[xs objectAtIndex:(a)]intValue], [[ys objectAtIndex:(a)]intValue], M3);
                NSNumber *xy = [NSNumber numberWithDouble:(pt.c[0][0])];
                NSNumber *yx = [NSNumber numberWithDouble:(pt.c[1][0])];
                [xs addObject:xy];
                [ys addObject:yx];
        ...
        if (g4 == 1) {
            for (int a = p; a != p + pow(gens, i) * vertices; a++) {
                pt = ApplyMatrixToPoint2([[xs objectAtIndex:(a)]intValue], [[ys objectAtIndex:(a)]intValue], M4);
                NSNumber *xy = [NSNumber numberWithDouble:(pt.c[0][0])];
                NSNumber *yx = [NSNumber numberWithDouble:(pt.c[1][0])];
                [xs addObject:xy];
                [ys addObject:yx];
